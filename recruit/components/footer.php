<footer class="footer">
  ...
  <div class="container">
    <div class="pc">
      <div class="footer__flex">
        ...
        <div class="footer__link"><a href="https://one-yubi.info/" target="_blank">営業サイトはこちらから</a></div>
      </div>
  ...
  <div class="tab">
    <div class="footer__tabLink"><a href="https://one-yubi.info/" target="_blank">営業サイトはこちらから</a></div>
    <div class="footer__tabButton-wrapper">
      ...
      <button class="footer__tabButton__link">
        <a href="https://line.me/R/ti/p/XGQ3edgCC5" target="_blank">
          <img src="<?php echo $path; ?>assets/images/footer-line.png" alt="ライン">
        </a>
      </button>
